...
def main(_):
  # Import data
  mnist = MNIST_Generator(FLAGS.data_dir)
  ...
  with tf.Session() as sess:
    ...
    for i in range(1, FLAGS.num_iter + 1):
      batch_images, batch_labels = mnist.next_train_batch(FLAGS.batch_size)
    ...
    print('test accuracy %g' % accuracy.eval(feed_dict={x: test_batch[0],
                                                        y_: test_batch[1]}))
